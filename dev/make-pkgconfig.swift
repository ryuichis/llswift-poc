...
// Derived from https://github.com/trill-lang/LLVMSwift/blob/master/utils/make-pkgconfig.swift
...
func makeFile() throws {
  ...
  //         "in your PATH"
  // }
  let llvmConfig = "clang+llvm-4.0.0-x86_64-apple-darwin/bin/llvm-config"
